    ...
    metodos: {
        agregar: (id, cantidad) => {
            ...
            if (ELEMENTO_CARRITO) {
                ...
                CARRITO_DE_COMPRAS.metodos.inventario(id, cantidad + ELEMENTO_CARRITO.cantidad) ? ELEMENTO_CARRITO.cantidad++ : alert("No hay más inventario")
        ...
        borrar: (id, cantidad) => {
            ...
            (ELEMENTO_CARRITO.cantidad - 1 > 0) ? ELEMENTO_CARRITO.cantidad-- : CARRITO_DE_COMPRAS.elementos = CARRITO_DE_COMPRAS.elementos.filter((elemento) => elemento.id !== id);
